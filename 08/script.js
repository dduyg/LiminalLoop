...
!(function () {
  ...
  (e.fov = 2 * Math.atan(2 / (2 * e.position.z)) * (180 / Math.PI)),
    ...
    ((M = new a(q, 25, 25)).userData.title = "Astroidal Ellipsoid"),
    r.push(M),
    ...
    r.push(M),
    (M = new a(b, 15, 15)).scale(0.3, 0.3, 0.3),
    (M.userData.title = "twistedSphere"),
    r.push(M),
    (M = new a(S, 50, 25)).rotateX(-Math.PI / 4),
    ...
    r.push(M),
    (M = new a(H, 20, 25)).scale(2, 2, 2),
    (M.userData.title = "egg"),
    r.push(M),
    (M = new a(C, 50, 20)).rotateX(-Math.PI / 2),
    M.scale(0.2, 0.2, 0.2),
    (M.userData.title = "Julia's Parametric Heart Surface"),
    r.push(M),
    (M = new a(R, 25, 25)).rotateX(-Math.PI / 4),
    M.scale(0.1, 0.1, 0.1),
    ...
    (function t() {
      ...
      (function () {
        ...
        c.forEach(function (t) {
          ...
          t.children[0].rotation.y = 3e-4 * Date.now();
          let s = e.width,
            n = e.height;
